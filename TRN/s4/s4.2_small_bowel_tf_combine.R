...
# combine
load('your-working-directory/intestine/intestine_hts1.RData')
load('your-working-directory/intestine/intestine_hts2.RData')
load('your-working-directory/intestine/intestine_hts3.RData')
load('your-working-directory/intestine/intestine_hts4.RData')
load('your-working-directory/intestine/intestine_hts5.RData')
load('your-working-directory/intestine/intestine_hts6.RData')
load('your-working-directory/intestine/intestine_hts7.RData')
load('your-working-directory/intestine/intestine_hts8.RData')
load('your-working-directory/intestine/intestine_hts9.RData')
load('your-working-directory/intestine/intestine_hts10.RData')
load('your-working-directory/intestine/intestine_hts11.RData')
load('your-working-directory/intestine/intestine_hts12.RData')
load('your-working-directory/intestine/intestine_hts_h1.RData')
load('your-working-directory/intestine/intestine_hts_s1.RData')
