...
# combine
load('your-working-directory/liver/liver_hts1.RData')
load('your-working-directory/liver/liver_hts2.RData')
load('your-working-directory/liver/liver_hts3.RData')
load('your-working-directory/liver/liver_hts4.RData')
load('your-working-directory/liver/liver_hts5.RData')
load('your-working-directory/liver/liver_hts6.RData')
load('your-working-directory/liver/liver_hts7.RData')
load('your-working-directory/liver/liver_hts8.RData')
load('your-working-directory/liver/liver_hts9.RData')
load('your-working-directory/liver/liver_hts10.RData')
load('your-working-directory/liver/liver_hts11.RData')
load('your-working-directory/liver/liver_hts12.RData')
load('your-working-directory/liver/liver_hts_h1.RData')
load('your-working-directory/liver/liver_hts_s1.RData')
