...
save(gtex_exp, gtex_pheno, file='your-working-directory/GTEX/gtex_processed_tpm_symbol.RData')
save(gtex_brain_exp, gtex_liver_exp, gtex_lung_exp, gtex_colon_exp, gtex_stomach_exp, gtex_intestine_exp,gtex_brain_cortex_exp, gtex_hippocampus_exp, file='your-working-directory/GTEX/gtex_tissue_exp.RData')
