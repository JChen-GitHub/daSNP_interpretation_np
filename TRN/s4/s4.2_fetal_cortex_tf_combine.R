...
# combine
load('your-working-directory/fetal_brain/fetal_brain_hts1.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts2.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts3.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts4.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts5.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts6.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts7.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts8.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts9.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts10.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts11.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts12.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts_h1.RData')
load('your-working-directory/fetal_brain/fetal_brain_hts_s1.RData')
