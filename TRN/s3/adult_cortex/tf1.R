...
J1 <- read.table('your-working-directory/j1.tsv',sep='\t',header = T)
...
adult_brain_hts1 <- adult_brain_hts

save(adult_brain_hts1, file='your-working-directory/adult_brain/adult_brain_hts1.RData')
