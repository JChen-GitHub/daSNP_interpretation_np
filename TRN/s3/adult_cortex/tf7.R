...
J1 <- read.table('your-working-directory/j7.tsv',sep='\t',header = T)
...
adult_brain_hts7 <- adult_brain_hts
#brain_hts <- brain_hts_o

save(adult_brain_hts7, file='your-working-directory/adult_brain/adult_brain_hts7.RData')
