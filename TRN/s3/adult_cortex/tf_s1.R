...
J1 <- read.table('your-working-directory/s1.tsv',sep='\t',header = T)
...
adult_brain_hts_s1 <- adult_brain_hts
#brain_hts <- brain_hts_o

save(adult_brain_hts_s1, file='your-working-directory/adult_brain/adult_brain_hts_s1.RData')
