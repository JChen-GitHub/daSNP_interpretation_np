...
library(WGCNA)
setwd('your-working-directory/WGCNA/exp_gene_100/')
load('your-working-directory/WGCNA/gtex_wgcna.RData')
allowWGCNAThreads()
...
write.csv(summary_m, file='your-working-directory/exp_gene_100_summary_module_size.csv')
